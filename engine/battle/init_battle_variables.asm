...
.linkBattle1
	...
	ld [hl], a
	ld hl, wEnemyMon1PP
	ld bc, wEnemyMon2PP - wEnemyMon1PP - 2 ; this might need to have an additional `ld [hli], a` and make this offset -3 on the ld bc because it might just be that enemy data is loaded after this
	ld d, 6
.enemyMonPPWipeLoop
	ld [hli], a
	ld [hli], a
...
.attackToPrime
	push de
	call MoveCheckPreRequisiteInitial ; d and e should be just fine for returning primary and secondary types respectively. And that's all I really need to know, is what type it wants energy for.
